package com.erlan.spring.rest.configuration;
...
@Configuration
@ComponentScan(basePackages = "com.erlan.spring.rest")
@EnableWebMvc
...
public class MyConfig {
    ...
    public LocalSessionFactoryBean sessionFactory(){
        ...
        sessionFactory.setPackagesToScan("com.erlan.spring.rest.entity");
